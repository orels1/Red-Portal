...
describe('Admin', () => {
    ...
    describe('PUT /admin/hide/:author/:repoName', () => {
        before(() => {
            return Cog.remove({})
                .then(() => {
                    return Repo.remove({});
        ...
        it('it should hide repo and all it\'s cogs', () => {
            return chai.request(app)
                .put(`${apiUrl}/admin/hide/orels1/ORELS-Cogs`)
                .set('Service-Token', process.env.serviceToken)
                .then((res) => {
                    res.should.have.status(200);
                    res.body.error.should.be.false;
                    res.body.results.should.equal('Repo hidden');
                })
                .catch((err) => {
                    throw err;
                });
    ...
    describe('PUT /admin/unhide/:author/:repoName', () => {
        before(() => {
            return Cog.remove({})
                .then(() => {
                    return Repo.remove({});
        ...
        it('it should hide repo and all it\'s cogs', () => {
            return chai.request(app)
                .put(`${apiUrl}/admin/unhide/orels1/ORELS-Cogs`)
                .set('Service-Token', process.env.serviceToken)
                .then((res) => {
                    res.should.have.status(200);
                    res.body.error.should.be.false;
                    res.body.results.should.equal('Repo will be shown now');
                })
                .catch((err) => {
                    throw err;
                });
